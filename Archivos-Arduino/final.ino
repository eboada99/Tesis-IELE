...
IPAddress server(157, 253, 38, 32);  // Replace with the IP address of your Python server
...
void loop() {
  ...
  float Samples_I = 0;
  //SENSORES
  float BPW21 = analogRead(A4); // Valor sensor de luz BPW21
  ...
  delay(10000);  // Wait for a while before sending the next data
}
